...
public class SpringBootAwsCloudWatchLogsApplication {
	...
	private final static Logger controllerLogger = LoggerFactory.getLogger(SpringBootAwsCloudWatchLogsApplication.class);
	...
	public ResponseEntity<String> getDashboardPanelInformation() {
		controllerLogger.info("User called the controller....");
